...
echo -e " \e[1;37m[\e[1;32mc\e[1;37m] УСТАНОВИТЬ ДРОВА\e[0m"
...
case $choice in
    ...
    3)
        ...
        # Отправляем запрос на API Кликера
    ...
    5) 
        ...
        sleep 2 
        ;;
    6) git add . && git commit -m "Update: clck.ru support" && git push origin main ;;
    8) 
        rm -rf images/* visits/*
